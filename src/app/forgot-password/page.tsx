...
import { LineChart, Mail, ArrowRight, Loader2, ArrowLeft } from "lucide-react";
              ...
              {success ? (
                <div className="space-y-6 relative z-10 text-center">
                  <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-sm p-4 rounded-lg animate-in fade-in slide-in-from-top-2">
                    If that email exists, a reset link has been sent. Check your terminal console (since we are testing locally)!
                  </div>
                  <Link 
                    href="/login"
                    className="inline-flex justify-center items-center py-3 px-4 w-full text-sm font-medium text-amber-500 hover:text-amber-400 transition-colors"
                  >
